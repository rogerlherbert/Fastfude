...
<div class="field">
	...
	<?php echo form_textarea('page_text', set_value('page_text')); ?>
	<?php echo form_error('page_text','<span class="form_error">','</span>'); ?>
</div>

<div class="field" id="submit"><?php echo form_submit(array('name' => 'confirm', 'value' => 'Create Wiki Page', 'class' => 'button')); ?></div>

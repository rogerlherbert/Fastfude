...
class Install extends CI_Controller
{
	...
	function __construct()
	{
		...
		$this->schema = array(
			...
			'topics' => "`id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT, `title` varchar(64) NOT NULL, `is_locked` tinyint(1) unsigned NOT NULL DEFAULT '0', `replies` int(10) unsigned NOT NULL DEFAULT '0', `post_id_first` int(10) unsigned NOT NULL DEFAULT '0', `post_time_first` datetime NOT NULL, `user_id_first` int(10) unsigned NOT NULL DEFAULT '0', `post_id_last` int(10) unsigned NOT NULL DEFAULT '0', `post_time_last` datetime NOT NULL, `user_id_last` int(10) unsigned NOT NULL DEFAULT '0', PRIMARY KEY (`id`), KEY `post_id_first` (`post_id_first`), KEY `user_id_first` (`user_id_first`), KEY `post_time_first` (`post_time_first`)",
			...
			'users_old' => "`user_id` int(10) unsigned NOT NULL, `username` varchar(25) NOT NULL DEFAULT '', `old_password` varchar(32) DEFAULT NULL, PRIMARY KEY (`user_id`), KEY `username` (`username`)",

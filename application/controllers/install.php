...
class Install extends CI_Controller
{
	...
	function __construct()
	{
		...
		$this->schema = array(
			...
			'messages' => "`id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT, `post_text` text NOT NULL, `post_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, `from_id` int(10) unsigned NOT NULL DEFAULT '0', `bin_state` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '0 = none, 1 = sender binned, 2 = receiver binned, 3 = both binned', `is_read` tinyint(1) NOT NULL DEFAULT '0', PRIMARY KEY (`id`), KEY `from_id` (`from_id`,`to_id`), KEY `bin_state` (`bin_state`)",
